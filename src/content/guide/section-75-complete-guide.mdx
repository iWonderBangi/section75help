...
<div class="not-prose my-6 rounded-lg border border-gray-200 bg-gray-50 px-5 py-4 text-sm text-gray-700">
  <p class="font-semibold text-gray-900 mb-3">In a rush?</p>
  <p class="mb-2">You probably want Section 75 if:</p>
  <ul class="space-y-1 mb-3">
    <li>&#10003; you paid at least part by credit card</li>
    <li>&#10003; the item or service cost more than £100 and up to £30,000</li>
    <li>&#10003; the seller failed to deliver, supplied faulty goods, misled you, or went bust</li>
  </ul>
  <p><strong>Next step:</strong> use the <a href="/" class="underline">free checker</a>, then send the template letter.</p>
</div>
