...
<div class="not-prose my-6 rounded-lg border border-gray-100 bg-gray-50 px-5 py-4 text-sm text-gray-700">
...
<div class="not-prose my-5 rounded-lg border border-blue-100 bg-blue-50 px-4 py-3 text-sm text-gray-700">
  <p class="font-semibold text-gray-800 mb-2">Not sure what the "total purchase price" means?</p>
